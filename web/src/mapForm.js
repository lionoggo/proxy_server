					...
					<form className="uk-form uk-form-stacked mapAddNewForm">
					    <fieldset>
					        <div className="uk-form-row">
				                <label className="uk-form-label" htmlFor="map_keywordInput">关键词</label>
					        ...
					        <div className="uk-form-row">
				                <label className="uk-form-label" htmlFor="map_localFilePath">本地文件</label>
				                <div className="uk-form-controls">
	            	        ...
	            	        <div className="uk-form-row">
		            	        <button type="button" className="uk-button" onClick={self.submitData}>添加</button>
	                        </div>

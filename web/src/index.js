    ...
    (function () {
        var TopBtn = React.createClass({
            ...
            render: function () {
                ...
                return <a href="#"><span className={btnClass} onClick={self.props.onClick}><i
                    className={iconClass}></i>{self.props.title}</span></a>
            }
        });
        ...
        filterBtn = React.render(<TopBtn icon="uk-icon-filter" title="过滤"
        ...
        var safeBtn,
            ...
            safePanelEl;
        safeBtn = React.render(<TopBtn icon="uk-icon-filter" title="安全"
                                       onClick={safeBtnClick}/>, document.getElementById("J_safeBtnContainer"));
        safePanelEl = (<SafePanel />)
        //打开面板
        ...
        require("./mapPanel").fetchConfig(function (initConfig) {
            ...
            mapBtn = React.render(<TopBtn icon="uk-icon-shield" title="本地映射"

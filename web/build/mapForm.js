					...
					React.createElement("form", {className: "uk-form uk-form-stacked mapAddNewForm"}, 
					    React.createElement("fieldset", null, 
					        React.createElement("div", {className: "uk-form-row"}, 
				                React.createElement("label", {className: "uk-form-label", htmlFor: "map_keywordInput"}, "关键词"), 
					        ...
					        React.createElement("div", {className: "uk-form-row"}, 
				                React.createElement("label", {className: "uk-form-label", htmlFor: "map_localFilePath"}, "本地文件"), 
				                React.createElement("div", {className: "uk-form-controls"}, 
	            	        ...
	            	        React.createElement("div", {className: "uk-form-row"}, 
		            	        React.createElement("button", {type: "button", className: "uk-button", onClick: self.submitData}, "添加")
	                        )
